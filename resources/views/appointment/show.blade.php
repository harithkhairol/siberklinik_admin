                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <div class="grid grid-cols-6 gap-5">
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <textarea type="text" value="{{ $appointment->outcome }}" name="outcome" id="outcome" autocomplete="description" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-base h-60 bg-gray-100" disabled>{{ $appointment->outcome }}</textarea>
                                            </div>
